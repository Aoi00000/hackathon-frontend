...
export type SupportMessage = { id: number; userId: number; userName: string; body: string; createdAt: string };
export type RecommendationResponse = { reason: string; items: Item[] };
