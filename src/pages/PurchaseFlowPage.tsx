...
export function PurchaseFlowPage() {
  ...
  async function charge() {
    ...
    try { setLatestUser(await authApi.charge(amount)); setChargeInput(''); setError(''); setMessage(`${amount.toLocaleString('ja-JP')}コインをチャージしました。`); } catch (e) { setError(e instanceof Error ? e.message : 'チャージに失敗しました'); }
  }
